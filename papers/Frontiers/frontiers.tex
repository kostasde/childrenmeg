...
\begin{table}[t]
  ...
  \begin{tabular}{| l | c | c | c | c |}
    \toprule
    \multicolumn{1}{l}{\textbf{Feature set}} & \multicolumn{1}{c}{\textbf{RMSE Mean}} & \multicolumn{1}{c}{\textbf{RMSE Variance} & \multicolumn{1}{c}{\textbf{MAE Mean}} & \multicolumn{1}{c}{\textbf{MAE Variance}} \\
    \toprule
