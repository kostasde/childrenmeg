...
Machine learning is proving to be a valuable tool in the analysis of biological data. It is being used for DNA stuff \cite{}, learning clusters . Machine learning has also been applied with varying success to data recorded from brain activity, in the form of magnetoencephalography (MEG), electroencephalogrophy (EEG) and functional magnetic resonance imaging (fMRI). Al
...
\begin{itemize}
\item Machine learning is proving to be a valuable tool in applications classically associated with AI, as well as other fields
