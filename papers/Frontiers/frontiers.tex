...
Modern machine learning (ML) is being used as a tool in the analysis of various types of biological data. It is being used for DNA stuff \cite{}, learning clusters... ML has also been applied with varying success to classify and interpret recordings of brain activity in the form of magnetoencephalography (MEG), electroencephalogrophy (EEG) and functional magnetic resonance imaging (fMRI).
