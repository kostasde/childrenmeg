...
Synchronization of neural oscillations have proven many times to be an effective mechanistic explanation for various cognitive and perceptual processes \cite{Fries2015} \cite{Uhlhass2009} \cite{NeuralSync}. A little bit more about the idea in my words. Doesburg et. al. \cite{Doesburg2016} show that  
